...
class NavTest():
        ...
        while not rospy.is_shutdown():
            ...
            # Get the next location in the current sequence
                ...
                if not finished_within_time:
                    ...
                    if state == GoalStatus.SUCCEEDED:
                        ...
                        # INPUT = ['joint_lift', 'wrist_extension', 'joint_wrist_yaw', 'joint_head_pan', 'joint_head_tilt']
                        self.move_arm([0.7, 0.1, 0.0, -0.9, -0.9])
            ...
            for w in range(3):
                ...
                for i in range(7):
                    ...
                    date_time = timestamp_array[w][i].strftime("%H_%M_%S")
                    img_name = date_time + "_img_" + img_no + ".png"
                    source = new_source + img_name
                    detect(source,new_project,date_time,img_name)
    ...
    def get_image(self,waypoint):
        ...
        while(img_counter < 7):
            ...
            # Get time
            timestamp_array[waypoint][img_counter-1] = datetime.datetime.now()
            date_time = timestamp_array[waypoint][img_counter-1].strftime("%H_%M_%S")
