...
class NavTest():
    def __init__(self):
        ...
        locations= [\
                    Pose(Point(1.932, -0.944, 0.000), Quaternion(0.000, 0.000, -0.124, 0.992)), # waypoint1 \
                    Pose(Point(3.161, 0.557, 0.000), Quaternion(0.000, 0.000, 0.990, 0.134)), # waypoint2 \
                    Pose(Point(0.194, -0.684, 0.000), Quaternion(0.000, 0.000, -0.730, 0.682)), # waypoint3 \
                    ]
        ...
        # loc_list = probabalistic_things("keys",locations)
        loc_list = [0,1,2]
