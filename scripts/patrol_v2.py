...
class NavTest():
    def __init__(self):
        ...
        for loc in self.location_data.keys():
            locations.append([Pose(Point(self.location_data[loc]["pose"]["position"]), Quaternion(self.location_data[loc]["pose"]["orientation"]))])
    ...
    def get_image(self,waypoint):   
        ...
        directory = self.root_imgs+self.location_data[waypoint]
