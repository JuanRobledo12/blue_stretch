...
class JSON_Handler:
    ...
    def __init__(self, max_image_storage, json_file_name, new_json=False):
        ...
        # self.waypoint_names = ["Kitchen", "Living Room"]
        # self.waypoint_positions = [
        #     [-3.7786247730255127, -2.414886236190796, 0],
        #     [-3.591975212097168, -1.040771484375, 0]
        # ]
        # self.waypoint_orientations = [
        #     [0, 0, 0.9999786001338603, 0.0065421154319592325],
        #     [0, 0, 0.7094075846424854, 0.704798466834112]
        # ]

        self.waypoint_list = ["waypoint_1", "waypoint_2", "waypoint_3", "waypoint_4", "waypoint_5", "waypoint_6", "waypoint_7", "waypoint_8", "waypoint_9", "waypoint_10", "waypoint_11", "waypoint_12"]
        self.waypoint_names = ["Kitchen", "Kitchen", "Kitchen", "Living Room", "Living Room", "Living Room", "Living Room", "Laundry room", "Office", "Bathroom", "Bedroom 1", "Bedroom 2"]
        self.waypoint_positions = [
                                    [-3.7786247730255127, -2.414886236190796, 0],
                                    [-3.591975212097168, -1.040771484375, 0],
                                    [-2.9943723678588867, -2.2064530849456787, 0],
                                    [-0.9331660270690918, -3.810365676879883, 0],
                                    [-0.6958990097045898, -4.002538681030273, 0],
                                    [0.5702148675918579, -0.45569533109664917, 0],
                                    [2.089517593383789, -1.3541762828826904, 0],
                                    [-0.49193263053894043, 2.8501291275024414, 0],
                                    [-1.2036025524139404, 3.0047807693481445, 0],
                                    [-1.4174727201461792, 5.705358982086182, 0],
                                    [-0.7242820262908936, 7.054316520690918, 0],
                                    [-1.6974481344223022, 6.971395969390869, 0]
                                ]
        self.waypoint_orientations = [
                                    [0, 0, 0.9999786001338603, 0.0065421154319592325],
                                    [0, 0, 0.7094075846424854, 0.704798466834112],
                                    [0, 0, -0.7143176001199206, 0.6998216673974286],
                                    [0, 0, 0.9999926004613064, 0.003846949783123918],
                                    [0, 0, 0.013083605250497935, 0.9999144059736559],
                                    [0, 0, 0.003317531399193913, 0.999994496977566],
                                    [0, 0, -0.7022324297955755, 0.7119477611056881],
                                    [0, 0, -0.006288086534414319, 0.9999802297884373],
                                    [0, 0, -0.9954032787583883, 0.09577219135558242],
                                    [0, 0, -0.9965341615267547, 0.0831845232610492],
                                    [0, 0, 0.007939593336931084, 0.9999684809320962],
                                    [0, 0, -0.9999948555277014, 0.003207634351302413]
                                ]
