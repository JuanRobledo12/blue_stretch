...
json_handler = JSON_Handler(5, '/home/hello-robot/yolov7/waypoint_info.json', new_json=False)
...
def main():
    ...
    while(img_counter < 2):
        ...
        timestamp_array[0][img_counter-1] = date_time
        #print(timestamp_array)
    ...
    for i in range(2):
        ...
        date_time = timestamp_array[0][img_counter-1]
        img_name = date_time + "_img_" + img_no + ".png"
        new_source = "/home/hello-robot/yolov7/images_demo/waypoint1/" + img_name
        new_project = "/home/hello-robot/yolov7/images_result/waypoint1"
        detect(new_source,new_project,date_time,img_name)


def detect(new_source,new_project, date_time,img_name,save_img=True):
    source, weights, view_img, save_txt, imgsz, trace = new_source, opt.weights, opt.view_img, opt.save_txt, opt.img_size, not opt.no_trace
    ...
    save_dir = Path(opt.project, exist_ok=opt.exist_ok)
    ...
    for path, img, im0s, vid_cap in dataset:
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            p = Path(p)  # to Path
            save_path = str(save_dir / img_name)  # img.jpg
            print(img_name)
            ...
            if len(det):
                ...
                for c in det[:, -1].unique():
                    ...
                    for j in range(n):
                        objects_array.append(f"{names[int(c)]}")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--project', default='/home/hello-robot/yolov7/images_result/waypoint1', help='save results to project/name')
