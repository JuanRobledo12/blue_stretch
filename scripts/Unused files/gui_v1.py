...
# We will make the title of our app as Image Viewer (replace with "Last seen locations of")
...
imgNum=data.keys()
#make empty list of images and timestamps
List_images = []
#List_timesdates = []

for img in imgNum:
    image = ImageTk.PhotoImage(Image.open(data[img]["name"]))
    #timeday = data([img]["timestamp"])
    List_images.append(image)
    #List_timesdates.append(timeday)
...
# image_no_1 = ImageTk.PhotoImage(Image.open("keyskitchentable.jpeg"))
# image_no_2 = ImageTk.PhotoImage(Image.open("keysoncouch.jpeg"))
# image_no_3 = ImageTk.PhotoImage(Image.open("keysoncoffeetable.jpeg"))
# image_no_4 = ImageTk.PhotoImage(Image.open("keysinfridge.webp"))
